...
export const CardTitle = ({ className, children }: { className?: string; children: React.ReactNode }) => {
    return <h4 className={cn('text-zinc-600 dark:text-zinc-200', 'font-bold tracking-wide mt-4', className)}>{children}</h4>
}

export const CardDescription = ({ className, children }: { className?: string; children: React.ReactNode }) => {
    return <p className={cn('mt-8 tracking-wide leading-relaxed text-sm', 'text-zinc-500 dark:text-zinc-300/[0.8]', className)}>{children}</p>
}
